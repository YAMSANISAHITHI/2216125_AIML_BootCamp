...
def predict():
    ...
    print(output)
    if output[0] == 0:
        return render_template('index.html', pred=f'The person is not suffering with malaria')
    else:
        return render_template('index.html', pred=f'The person is suffering with malaria')
